...
class AccessTokenController extends Controller
{
    ...
    public function get_rtc_token(Request $request){
        ...
        $appID = "0bf7c4fdb6504384b986977396a34cb4";
        $appCertificate = "8bc3177a49fa4ad1940d894f6d31507a";
        $uid = 0; // if we dont assign any uid, Agora will assign automatically.
        $xpireTimeInSeconds = 7200; /// 2 Hours i.e. 2*60*60. Maximum duration that 2 people can stay in a call

        /// DBESTECT LINK https://www.dbestech.com/tutorials/agora-and-php-integration

        $accessToken =  new AccessToken2($appID, $appCertificate, $xpireTimeInSeconds);
        $serviceRtc = new ServiceRTC($channelName, $uid);
        $serviceRtc->addPrivilege($serviceRtc::PRIVILEGE_JOIN_CHANNEL, $xpireTimeInSeconds); 
